...
const AnalyzeAnswerItem = ({ order, text }: ItemProps) => {
  ...
  return (
    <motion.div className={styles.anwerItemContainer}>
      ...
      <AnimatePresence initial={false}>
        {expanded && (
          <motion.div
            className={styles.bottomContentsContainer}
          ...
          >
            ...
            <div className={styles.myAnswerContainer}>
              <p>
                ...
                주로 React와 TypeScript를 사용하여 사용자 중심의 웹
                애플리케이션을 개발해왔습니다. 이전 회사에서는 팀 리더로서 5명의
                개발자와 함께 프로젝트를 성공적으로 완료한 경험이 있습니다.
              </p>
            </div>
            <div className={styles.contentsTitle}>
              <BotIcon size={15} />
