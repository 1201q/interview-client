...
import UserDeletedQuestionListClient from './UserDeletedQuestionListClient';

const UserDeletedQuestionListServer = async () => {
...
export default UserDeletedQuestionListServer;
